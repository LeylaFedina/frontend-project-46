...
test.each([
  {file1: getFixturePath('file1.json'), file2: getFixturePath('file2.json'),
  expected: readFile('resultTree.txt'), format: '', testName: 'main JSON test'},
  {file1: getFixturePath('file1.yml'), file2: getFixturePath('file2.yml'),
  expected: readFile('resultTree.txt'), format: '', testName: 'main YML test'},
  {file1: getFixturePath('file1.json'), file2: getFixturePath('file2.json'),
   expected: readFile('resultPlain.txt'), format: 'plain', testName: 'Plain gendiff test'},
  {file1: getFixturePath('file1.json'), file2: getFixturePath('file2.json'),
  expected: readFile('resultJSON.txt'), format: 'json', testName: 'JSON gendiff test'},
